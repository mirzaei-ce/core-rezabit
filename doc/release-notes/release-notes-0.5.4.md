Rezabit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/rezabit/files/Rezabit/rezabit-0.5.4/
...
http://gitorious.org/rezabit/rezabitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Rezabit-Qt notifications under Growl 1.3.
Increase required age of Rezabit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxRezabit properly when installing Rezabit-Qt over it. (Windows)
