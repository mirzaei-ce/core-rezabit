Rezabit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/rezabit/files/Rezabit/rezabit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Rezabit
...
New/changed settings (command-line or rezabit.conf file)
--------------------------------------------------------
