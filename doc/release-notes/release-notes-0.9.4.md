Rezabit Core version 0.9.4 is now available from:

  https://rezabit.org/bin/0.9.4/
...
this update is incompatible with the Rezabit system and could lead to consensus
forks.

Rezabit Core released binaries from https://rezabit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~rezabit/+archive/ubuntu/rezabit
- A third-party or self-compiled Rezabit Core

upgrade to Rezabit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
