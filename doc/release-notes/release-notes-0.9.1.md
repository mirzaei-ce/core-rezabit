Rezabit Core version 0.9.1 is now available from:

  https://rezabit.org/bin/0.9.1/
...
rezabitd from any pre-0.9.1 version, and have enabled SSL for RPC and
...
- Upgrade OpenSSL to 1.0.1g. This release fixes the following vulnerabilities which can
  affect the Rezabit Core software:
