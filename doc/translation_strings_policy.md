...
This document provides guidelines for internationalization of the Rezabit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `rezabit_en.ts` remains unchanged.
