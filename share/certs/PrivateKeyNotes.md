...
unlocked to sign the Rezabit-Qt.app bundle.
...
allowing somebody to distribute a Rezabit-Qt.app or rezabit-qt-setup.exe with a valid
...
that the rezabit-qt.exe file inside the installer had not been tampered with.
