...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CRezabitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CRezabitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CRezabitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CRezabitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CRezabitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CRezabitAddress(arr[0].get_str()).Get() == demoAddress.Get());
