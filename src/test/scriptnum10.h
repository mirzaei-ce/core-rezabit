...
#ifndef REZABIT_TEST_SCRIPTNUM10_H
#define REZABIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Rezabit Core 0.10.0, for cross-comparison.
 */
public:
