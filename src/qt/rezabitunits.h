...
#ifndef REZABIT_QT_REZABITUNITS_H
#define REZABIT_QT_REZABITUNITS_H
...
/** Rezabit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class RezabitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit RezabitUnits(QObject *parent);

    /** Rezabit units.
      @note Source: https://en.rezabit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MBT,
...
private:
    QList<RezabitUnits::Unit> unitlist;
};
typedef RezabitUnits::Unit RezabitUnit;

#endif // REZABIT_QT_REZABITUNITS_H
