...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/rezabit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Rezabit Core"),
     ...
     * override -datadir in the rezabit.conf file in the default data directory
     * (to be consistent with rezabitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
