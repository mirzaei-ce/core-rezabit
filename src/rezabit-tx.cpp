...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Rezabit Core rezabit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rezabit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rezabit transaction") + "\n" +
              "  rezabit-tx [options] -create [commands]   " + _("Create hex-encoded rezabit transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rezabit transaction
